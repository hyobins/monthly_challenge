...
public class MyprojectDetailActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.openchatURL.setOnClickListener(this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.infoText:
                ...
                break;
            case R.id.openchatURL:
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse(binding.openchatURL.getText().toString()));
