...
public class TeamListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View converView, ViewGroup parent) {
        ...
        switch (teamListItems.get(position).getApply_developers()){
            case 3 :
                imageView_developer1.setImageResource(R.drawable.indiv_color);
            case 2 :
                imageView_developer2.setImageResource(R.drawable.indiv_color);
            case 1 :
                imageView_developer3.setImageResource(R.drawable.indiv_color);
                break;
        }
        switch (teamListItems.get(position).getApply_designers()){
            case 3 :
                imageView_designer1.setImageResource(R.drawable.indiv_color);
            case 2 :
                imageView_designer2.setImageResource(R.drawable.indiv_color);
            case 1 :
                imageView_designer3.setImageResource(R.drawable.indiv_color);
                break;
        }
